...
pub fn can_have_fullhouse(cards:  &Vec<Card>) -> CanHaveCombis {
    ...
    if has_trips {
        ...
        for higher_group in &higher_groups {
            if higher_group.len() == 1 {
                ...
                fh_combis.push((
                    ...
                    vec![vec![vec![Card {value: higher_card.value, suit: Suit::A }, Card {value: trips_value, suit: Suit::A }]]]
                ));
            }
        }
        ...
        let mut g_combis: Vec<SameRankHands> = Vec::new();
        ...
        for (i, pair) in pairs.iter().enumerate() {
            ...
            if i == 0 {
                for higher_hand in &not_my_hands_higher {
                    ...
                    fh_combis.push((
                        ...
                        vec![vec![vec![Card { value: higher_card.value, suit: Suit::A }, Card { value: higher_card.value, suit: Suit::A }]]]
                    ));
                }
            }
            ...
            for not_my_hand in &not_my_hands_higher {
                ...
                fh_combis.push((
                    vec![higher_card, pair[0], pair[1]],
                    vec![vec![vec![Card {value: higher_card.value, suit: Suit::A}, Card {value: pair_value, suit: Suit::A}]]]
                ))
            ...
            for not_my_hand in &not_my_hands_lower {
                    ...
                    fh_combis.push((
                        ...
                        vec![vec![vec![Card {value: pair_value, suit: Suit::A}, Card { value: lower_card.value, suit: Suit::A }]]]
                    ))
            ...
            if i == 1 || pairs.len() == 1 {
                for lower_hand in &not_my_hands_lower {
                    ...
                    fh_combis.push((
                        vec![pair[0], pair[1], lower_card],
                        vec![vec![vec![Card { value: lower_card.value, suit: Suit::A }, Card { value: lower_card.value, suit: Suit::A }]]]
                    ));
                }
            }
        }
